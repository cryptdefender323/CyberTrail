...
def abuseipdb_check(target):
    console.print("[cyan]Checking AbuseIPDB status...[/cyan]")
    try:
        ...
        console.print("[red]✘ AbuseIPDB check failed.[/red]")
        return {"error": str(e)}

def virustotal_analysis(target):
    console.print("[cyan]Performing VirusTotal analysis...[/cyan]")
    try:
        response = requests.get(
        ...
        console.print("[red]✘ VirusTotal analysis failed.[/red]")
        return {"error": str(e)}

def shodan_analysis(target):
    console.print("[cyan]Performing Shodan analysis...[/cyan]")
    try:
        response = requests.get(
        ...
        console.print("[red]✘ Shodan analysis failed.[/red]")
        return {"error": str(e)}

def securitytrails_analysis(target):
    console.print("[cyan]Performing SecurityTrails analysis...[/cyan]")
    try:
        response = requests.get(
        ...
        console.print("[red]✘ SecurityTrails analysis failed.[/red]")
        return {"error": str(e)}

def wayback_machine_analysis(target):
    console.print("[cyan]Performing historical analysis (Wayback Machine)...[/cyan]")
    try:
